...
bridge_13 = BlennerhassettBridge(curve_fitting='Polynomial-n')
bridge_20 = BlennerhassettBridge(n_hangers=20, curve_fitting='Polynomial-n')
bridge_27 = BlennerhassettBridge(n_hangers=27, curve_fitting='Polynomial-n')

adapted_params = (1.0646, False, 267.8/(4*14))
bridge_26 = BlennerhassettBridge(hanger_params=adapted_params, n_hangers=26, curve_fitting='Polynomial-n')
