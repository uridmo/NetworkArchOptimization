...
bridge_20 = BlennerhassettBridge(n_hangers=20, n_cross_girders=20, self_stress_state='Zero-displacement', arch_optimisation=True)
bridge_27 = BlennerhassettBridge(n_hangers=27, n_cross_girders=27, self_stress_state='Zero-displacement', arch_optimisation=True)
