...
To conclude the previous observations, the deciding demand over capacity ratios are shown for each model and each segment in \cref{tab:dc_inclination}.
...
There are only minor changes in the effects under live loading. On the one hand the peaks in the arch's moment distribution increase for large changes in inclination. On the other hand, also the normal forces in the flat hangers increase. However, the effects under live loading generally only undergo minor changes. Further, the deciding D/C ratios are presented in \cref{tab:dc_constantchange}.

\begin{table}[H]
    \centering
    \caption{Maximum demand over capacity ratios for changing inclinations}
    \label{tab:dc_constantchange}
    \resizebox{0.9\columnwidth}{!}{%   
    \begin{tabular}{lccccccc}
    \hline
    Model & \multicolumn{7}{c}{Demand / Capacity} \\
     & Arch 1 & Arch 2 & Arch 3 & Tie 1 & Tie 2 & Tie 3 & Hangers \\ \hline
    105\degree-25\degree Arrangement & 0.77 (S3) & 1.13 (CL) & 1.08 (CL) & 0.69 (CL) & 0.92 (CL) & 0.93 (TF) & 1.03 (S1) \\ 
    95\degree-35\degree Arrangement & 0.79 (S3) & 1.12 (CL) & 1.09 (CL) & 0.72 (TF) & 0.91 (TF) & 0.92 (TF) & 0.99 (S1) \\ 
    85\degree-45\degree Arrangement & 0.80 (S3) & 1.12 (CL) & 1.10 (CL) & 0.74 (TF) & 0.91 (TF) & 0.92 (TF) & 0.96 (S1) \\ 
    75\degree-55\degree Arrangement & 0.81 (S3) & 1.12 (CL) & 1.10 (CL) & 0.76 (TF) & 0.92 (TF) & 0.91 (TF) & 0.95 (S1) \\ 
    65\degree Arrangement & 0.83 (S3) & 1.14 (CL) & 1.10 (CL) & 0.79 (TF) & 0.95 (TF) & 0.91 (TF) & 0.94 (S1) \\ 
    \hline
    \end{tabular}
    }
...
\begin{table}[H]
    \centering
    \caption{Maximum demand over capacity ratios for changing inclinations}
    \label{tab:cost_constant_change}
    \resizebox{0.64\columnwidth}{!}{%
    \begin{tabular}{lcccc}
    \hline
    Model & Arch cost & Tie cost & Hanger cost & Total cost \\
     & [\$ Mio.] & [\$ Mio.] & [\$ Mio.] & [\$ Mio.] \\ \hline
    105\degree-25\degree Arrangement & 5.28 & 3.44 & 1.70 & 10.42 \\ 
    95\degree-35\degree Arrangement & 5.30 & 3.44 & 1.63 & 10.37 \\ 
    85\degree-45\degree Arrangement & 5.33 & 3.46 & 1.59 & 10.38 \\ 
    75\degree-55\degree Arrangement & 5.36 & 3.50 & 1.58 & 10.44 \\ 
    65\degree Arrangement & 5.40 & 3.57 & 1.58 & 10.56 \\ 
    \hline
    \end{tabular}
    }
\end{table}
