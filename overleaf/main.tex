...
%% Nomenclature 
%% ---------------------------------------------------------
\printnomenclature    % \printnomenclature command prints the abbreviation/symbol list at the corresponding position of the document; to control the distance between the symbol or abbreviation and the explaining text use the optional distance argument. 
\cleardoublepage
